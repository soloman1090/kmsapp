    ...
    <div class="row mb-3">
        <div class="col-md-4 mg-t-10 mg-sm-t-0">
            <div class="card card-body">
                ...
                <div class="d-flex d-lg-block d-xl-flex align-items-end">
                    <h3 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1"> <b class="tx-30">$</b> {{ number_format($user->referral_wallet,2) }}</h3>
        ...
        <div class="col-md-4 mg-t-10 mg-lg-t-0">
            <div class="card card-body">
                ...
                <div class="d-flex d-lg-block d-xl-flex align-items-end">
                    <h3 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1"><b class="tx-30">$</b> {{ number_format($totalBonus,2) }}</h3> 
        ...
        <div class="col-md-4 mg-t-10 mg-lg-t-0">
            <div class="card card-body">
                ...
                <div class="d-flex d-lg-block d-xl-flex align-items-end">
                    <h3 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1"><b class="tx-30">$</b> 1,650</h3>

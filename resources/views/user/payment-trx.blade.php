        ...
        <div data-v-5e0cd238="" class="invoice">
            <div class="invoice__header header">
                <div class="header__top row_between">
                    <a href="https://palmalliance.com/" title="plisio" target="_blank" rel="noopener"
            ...
            <div class="invoice__contentWr">
                <div data-v-04d1a81a="" class="invoice__row_sum row_between">
                    <div data-v-04d1a81a="" class="row_sum__shop row_start">
                        ...
                        <div data-v-04d1a81a="" class="row_sum__shopName">Palmalliance Management</div>
                    </div>
                    <div data-v-04d1a81a="" class="row_sum__val">
                        <div data-v-04d1a81a="" class="row_sum__crypto">
                            ...
                            <div data-v-04d1a81a="" class="row_sum__amount"></div>
                            <div data-v-a6f121a6="" data-v-04d1a81a="" class="clipboard" style="display: none;">
                                <div data-v-a6f121a6="" class="clipboard__value"></div>
                            ...
                            @if ($currency=="TRX")
                            <div data-v-04d1a81a="" class="row_sum__curr">TRX</div>
                         @elseif ($currency=="Erc20")
                         <div data-v-04d1a81a="" class="row_sum__curr">USDT-Erc20</div>
                         @elseif ($currency=="Trc20")
                         <div data-v-04d1a81a="" class="row_sum__curr">USDT-Trc20</div>
                         @elseif ($currency=="ETH")
                         <div data-v-04d1a81a="" class="row_sum__curr">ETHEREUM</div>
                         @endif
                        </div>
                        <div data-v-04d1a81a="" class="row_sum__fiat">
                            ...
                            <div data-v-04d1a81a="" class="row_sum__curr_fiat">$</div>
                        </div>
                    </div>
                </div>
                <div class="invoice__content _white">
                    <div data-v-1e9a806c="" class="step step_pay">
                        <div data-v-1e9a806c="" class="step_pay__qr">
                         @if ($currency=="TRX")
                         <img src=" {{ asset('user-assets/images/trx-img.PNG') }}" alt="">
                         
                         @elseif ($currency=="Erc20")
                         <img src=" {{ asset('user-assets/images/erc-20.jpg') }}" alt="">
                         @elseif ($currency=="Trc20")
                         <img src=" {{ asset('user-assets/images/trc-20.jpg') }}" alt="">
                         @elseif ($currency=="ETH")
                         <img src=" {{ asset('user-assets/images/etherum.jpg') }}" alt="">
                         @endif
                        </div>
                        ...
                        <div data-v-1e9a806c="" class="invoice__hint">
                            To complete your payment, please send <strong id="step_pay__amount_payTo"
                                class="step_pay__amount">${{ $amount }}  </strong>
                            <strong id="step_pay__curr_payTo" class="step_pay__curr">Tron</strong>
                            to the address below:
                        </div>
                        <div data-v-1e9a806c="" class="step_pay__address" id="step_pay__address">TPQGQEim5DPuhsYdwRKRuLVYQK8Pkc4JQU</div>
                        @elseif ($currency=="Erc20")
                        <div data-v-1e9a806c="" class="invoice__hint">
                            To complete your payment, please send <strong id="step_pay__amount_payTo"
                                class="step_pay__amount">${{ $amount }}  </strong>
                            <strong id="step_pay__curr_payTo" class="step_pay__curr">USDT-Erc-20</strong>
                            to the address below:
                        </div>
                        <div data-v-1e9a806c="" class="step_pay__address" id="step_pay__address">0x91f9dD104b8f7504252BeF0587D1722e82aE4A0c</div>
                        @elseif ($currency=="Trc20")
                        <div data-v-1e9a806c="" class="invoice__hint">
                            To complete your payment, please send <strong id="step_pay__amount_payTo"
                                class="step_pay__amount">${{ $amount }}  </strong>
                            <strong id="step_pay__curr_payTo" class="step_pay__curr">USDT-Trc-20</strong>
                            to the address below:
                        </div>
                        <div data-v-1e9a806c="" class="step_pay__address" id="step_pay__address">TM6SiNJxaT6PVCfa4rQEyhKBHbJrcDNuXD</div>
                        @elseif ($currency=="ETH")
                        <div data-v-1e9a806c="" class="invoice__hint">
                            To complete your payment, please send <strong id="step_pay__amount_payTo"
                                class="step_pay__amount">${{ $amount }}  </strong>
                            <strong id="step_pay__curr_payTo" class="step_pay__curr">ETHEREUM</strong>
                            to the address below:
                        </div>
                        <div data-v-1e9a806c="" class="step_pay__address" id="step_pay__address">0x3beF7338feafD3383a910d81b317627f118178A0</div>
                        @endif

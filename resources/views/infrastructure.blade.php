...
<div class="margin_60_35">
    ...
    <div class="infr-bx-a">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 wmku-o">
                    <h6>Infrastracture</h6>
                    <h4>What Makes Us Different?</h4>
                </div>

                <div class="col-lg-6">
                    <div class="w-100 wmku-p">
                        <h6>Sourcing Advantage</h6>
                        <p>Our long-standing relationships, together with Goldman Sachs’ established infrastructure and utilities advisory practice, makes for a robust sourcing network of companies, entrepreneurs, governments, municipalities, and financial intermediaries around the world. </p>
                    </div>

                    <div class="w-100 wmku-p">
                        <h6>Navigating Complexity</h6>
                        <p>Complexity can come in many forms. It can be the early identification of emerging thematic trends, seeing through a dislocation or macro disruption, or a complex acquisition. Our investment process aims to focus on identifying and investing at key market inflection points, and seeks to navigate thematic trends, market dislocations and opportunities underappreciated by the wider market.</p>
                    </div>

                    <div class="w-100 wmku-p">
                        <h6>Value Creation Focus</h6>
                        <p>We act like owners and are dedicated to our goals of accelerating value creation and supporting our portfolio companies. Our process is focused on creating value across the investment life cycle, at acquisition, throughout our ownership and at exit.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="tari-bx">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 val-bx2">
                    <img src="assets/img/infrastructure/group_2582x.webp" alt="" />

                    <h6>Experience Across the Asset Life Cycle</h6>
                    <p>
                    Operational, construction, and development experience allow us to add-value and optimize asset performance
                    </p>
                </div>
                <div class="col-lg-4 val-bx2">
                    <img src="assets/img/infrastructure/group_2622x.webp" alt="" />

                    <h6>Robust Origination Capabilities</h6>
                    <p>Technical experience and industry relationships spanning more than two decades create opportunities for proprietary deal flow</p>
                </div>
                <div class="col-lg-4 val-bx2">
                    <img src="assets/img/infrastructure/group_2662x.webp" alt="" />

                    <h6>Flexible Capital Approach</h6>
                    <p>We provide bespoke solutions ranging from structured debt to equity investments across assets and platforms</p>
                </div>
            </div>
        </div>
    </div>

    <div class="last-infra">
        <div class="bg-cover">
            <div class="container infra-ft">
                <h1>“Infrastructure is one of our most active investment areas. We have a long history of investing in projects that improve quality of life for local communities.”</h1>
            </div>
        </div>
    </div>

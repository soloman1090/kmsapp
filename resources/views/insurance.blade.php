...
<section class="banner">
    ...
    <div class="sec4">
        <div class="sec4-">
            ...
            <div class="sec4-details">
                <div class="details-left"><img src="./img/banner.jpg" alt=""></div>
    ...
    <div class="sec5">
        <div class="sec5-">
            <h1>"</h1>
            <div class="sec5-details">
               <h3>We believe we can provide significant value by tailoring our expertise across the alternatives spectrum to meet the unique needs of insurance capital."</h3>
    ...
    <div class="sec7">
        <div class="sec7-">
            <h1>Senior Leadership
            </h1>
            <p>If you are interested in speaking to a member of the team, please email <a href="#">insurance@gcmlp.com</a></p>
            <div class="sec7-details">
                <div>
    ...
    <div class="sec8">
        <div class="sec8-">
            ...
            <div class="sec8-details">
                <div>
                    <h3>How Insurers Can Navigate Alternatives in 2023</h3>
                    <h6>March 2, 2023</h6>
                    <p>We explore the attractive alternatives opportunity set fir insurers and discuss how we believe they can best capitalize on that landscape in 2023</p>
                    <button>LEARN MORE</button>
                </div>
                <div>
                    <h3>Incorporate Alternative Into Insurance Portfolio Through Structured Solutions</h3>
                    <h6>September 19, 2022</h6>
                    <p>We look at the applicability of alternatives investments for insurers, discuss considerations insurers must keep in mind when making investment decisions, and explore several structures in depth</p>
                    <button>LEARN MORE</button>
                </div>
                <div>
                    <h3>GCM Grosvenor Raises $500 Million to Invest in Alternative Strategies as Part of GCM Grosvenor Insurance Solutionss</h3>
                    <h6>November 18, 2022</h6>

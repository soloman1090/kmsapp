...
//PAYMENT METHOD EDIT
var edit=$('.edit-payment-method');
    edit.click(function(){
        $('.modal-title').text("Update Payment Method")
       $('#method_name').val($(this).attr('name'))
       $('#method_address').val($(this).attr('address'))
       $('#update_payment_method_form').attr('action',$(this).attr('action'))
       $("#payment_method_image").css({"display":"block"}).attr('src',$(this).attr('image'))

       if($(this).attr('active')=="1"){
        $("#setPaymentMethodActive").text('Disable Method')
        $("#setPaymentMethodActive").attr('active',$(this).attr('active'))
        $("#paymentMethodActiveTXT").val($(this).attr('active'))
       }else{
        $("#setPaymentMethodActive").text('Enable Method')
        $("#setPaymentMethodActive").attr('active',$(this).attr('active'))
        $("#paymentMethodActiveTXT").val($(this).attr('active'))
       }

       $('#save_payment_method').text('Update Method')
})

$("#setPaymentMethodActive").click(function(){
    if($("#paymentMethodActiveTXT").val()=="1"){
        $("#paymentMethodActiveTXT").val("0")
        $("#setPaymentMethodActive").text('Disable Method')
       }else{
        $("#paymentMethodActiveTXT").val("1")
        $("#setPaymentMethodActive").text('Enable Method')
       }
...
// TRADER EDIT
$('.edit_trader_btn').click(function(){
$("#name").val($(this).attr('name'))
$("#position").val($(this).attr('position'))
$("#phone").val($(this).attr('phone'))
$("#mail").val($(this).attr('mail'))
$("#descp").val($(this).attr('descp'))
$("#link").val($(this).attr('link'))
$("#descp").val($(this).attr('descp'))
$("#trader_image").attr('src',$(this).attr('image'))
$("#update_trader_form").attr('action',$(this).attr('action'))
})

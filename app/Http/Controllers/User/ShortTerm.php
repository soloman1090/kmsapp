...
class ShortTerm extends Controller
{
    public function index()
    {
        ...
        return view('user.short-investments', ['user' => $user, 'user_id' => $id, 'page_title' => " ",'activities'=>$userActivities,
         'investments'=>$usersInvestments, 'packages' => $packages, 'username' => $user->name, "totalInvested"=> getAmountAttribute($totalInvested),
